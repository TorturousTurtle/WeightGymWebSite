...
const UserContextProvider: React.FC<UserContextProviderProps> = (
  ...
  const registerUser = async (registrationData: RegisterUserData) => {
    ...
    let carbs = registrationData.carbs && registrationData.carbs.length > 1 ? registrationData.carbs : "0";
    let fats = registrationData.fats && registrationData.fats.length > 1 ? registrationData.fats : "0";
    let proteins = registrationData.proteins && registrationData.proteins.length > 1 ? registrationData.proteins : "0";
    let tdee = registrationData.tdee && registrationData.tdee.toString().length > 1 ? parseFloat(registrationData.tdee as string) : 0;
