...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Weight Gym! - Privacy Policy</title>
        <meta
          name="description"
          content="Review the Weight Gym! privacy policy document"
        />
      </Head>
      <div className="flex flex-col items-center bg-white p-10">
        ...
        <p className="text-xl text-gray-900 w-3/4">
          Benjamin Verrill built the Weight Gym! app as an Ad Supported app.
          This SERVICE is provided by Benjamin Verrill at no cost and is
          ...
          Terms and Conditions, which is accessible at Weight Gym! unless
          ...
          <br />I want to inform users of this Service that these third parties
          ...
          not hesitate to contact me at weightgyminc@gmail.com.
        </p>
      </div>
    </>
  );
