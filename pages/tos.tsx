...
const TOS = () => {
  return (
    <>
      <Head>
        <title>Weight Gym! - Terms of Service</title>
        <meta
          name="description"
          content="Review the Weight Gym! terms of service document"
        />
      </Head>
      <div className="flex flex-col items-center bg-white p-10">
        <br />
        <h1 className="text-6xl font-monoton text-wg-green text-center">
          Terms&nbsp;&nbsp;of&nbsp;&nbsp;Service
        </h1>
        <br />
        <br />
        <p className="text-xl text-gray-900 w-3/4">
          ...
          make derivative versions. The app itself, and all the trade marks,
          copyright, database rights and other intellectual property rights
          related to it, still belong to Benjamin Verrill. <br />
          <br />
          Benjamin Verrill is committed to ensuring that the app is as useful
          ...
          for. <br />
          <br />
          The Weight Gym! app stores and processes personal data that you have
          ...
          the Weight Gym! app won&apos;t work properly or at all. <br />
          <br />
          ...
          <ul className="list-disc pl-12">
            <li>
              <a
                ...
                className="hover:underline focus:outline-none text-blue-900"
              >
          ...
          <br />
          You should be aware that there are certain things that Benjamin
          Verrill will not take responsibility for. Certain functions of the app
          ...
          but Benjamin Verrill cannot take responsibility for the app not
          ...
          have received permission from the bill payer for using the app. <br />
          <br />
          Along the same lines, Benjamin Verrill cannot always take
          ...
          can&apos;t turn it on to avail the Service, Benjamin Verrill cannot
          accept responsibility. <br />
          <br />
          With respect to Benjamin Verrill&apos;s responsibility for your use of
          ...
          information to us so that we can make it available to you. Benjamin
          Verrill accepts no liability for any loss, direct or indirect, you
          ...
          keep using the app. Benjamin Verrill does not promise that it will
          ...
          using the app, and (if needed) delete it from your device. <br />
          <br />
          <b>Changes to This Terms and Conditions</b> <br />
          <br />I may update our Terms and Conditions from time to time. Thus,
          ...
          on this page. These terms and conditions are effective as of
          2021-11-20 <br />
          <br />
          <b>Contact Us</b> <br />
          <br />
          If you have any questions or suggestions about my Terms and
          Conditions, do not hesitate to contact me at weightgyminc@gmail.com.
        </p>
      </div>
    </>
  );
